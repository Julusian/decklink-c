...
typedef void cdecklink_deck_control_status_callback_t;
typedef void cdecklink_deck_control_t;
typedef void cdecklink_video_output_callback_t;
typedef void cdecklink_input_callback_t;
typedef void cdecklink_encoder_input_callback_t;
typedef void cdecklink_memory_allocator_t;
typedef void cdecklink_audio_output_callback_t;
...
typedef void cdecklink_screen_preview_callback_t;
typedef void cdecklink_gl_screen_preview_helper_t;
typedef void cdecklink_notification_callback_t;
...
typedef void cdecklink_device_notification_callback_t;
